import 'package:photogenerator/bottom_modals/delete_gallery_image/delete_gallery_image_modal.dart';
...
class AppBottomModals {
  static List<AppBottomModal> get bottomModals => [
        ...
        AppBottomModal<DeleteGalleryImageModalBloc>(
          name: "/DeleteGalleryImageModal",
          dataSharingName: "DeleteGalleryImageModal",
          createBloc: (args) => DeleteGalleryImageModalBloc(args),
          createChild: (_) => DeleteGalleryImageModal(),
        ),
      ];
}
